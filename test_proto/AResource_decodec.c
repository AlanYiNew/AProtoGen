    ...
    switch (::google::protobuf::internal::WireFormatLite::GetTagFieldNumber(tag)) {
      ...
      case 13: {
        if (static_cast< ::google::protobuf::uint8>(tag) ==
          ...
          uint32_t* temp = &msg_obj->stObject.b;
          uint32_t value;
          if (!::google::protobuf::internal::WireFormatLite::ReadPrimitive<
      ...
      case 14: {
        if (static_cast< ::google::protobuf::uint8>(tag) ==
          ...
          ResInner* temp = &msg_obj->stObject.c;
          int32_t length;
          if (!input->ReadVarintSizeAsInt(&length)) {
            #ifdef ENABLE_PB_LOG
            GLOG_ERROR("ReadVarintSizeAsInt failed");
      ...
      case 15: {
        if (static_cast< ::google::protobuf::uint8>(tag) ==
          ...
          char* temp = &msg_obj->stringList[stringList_size][0];
          uint32_t length;
          if (!input->ReadVarint32(&length)) return -10;
          if (length >= 20) {
            #ifdef ENABLE_PB_LOG
      ...
      case 16: {
        if (static_cast< ::google::protobuf::uint8>(tag) ==
          ...
          while (input->BytesUntilLimit() > 0) {
            ...
            RES_NumVal* temp = &msg_obj->enumValList[enumValList_size];
            int value;
            if (!::google::protobuf::internal::WireFormatLite::ReadPrimitive<
      ...
      case 17: {
        if (static_cast< ::google::protobuf::uint8>(tag) ==
          ...
          RES_NumVal* temp = &msg_obj->enumVal;
          int value;
          if (!::google::protobuf::internal::WireFormatLite::ReadPrimitive<
            int, ::google::protobuf::internal::WireFormatLite::TYPE_ENUM>(
              input, &value)) return -2;
