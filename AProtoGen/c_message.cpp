...
GenerateEncodeUnitTest(Printer* printer) {
    ...
    printer->Print(
      ...
      "  std::cout << msg_obj_cpp.DebugString() << std::endl;\n"
      "  return false;\n"
      "}\n",
...
string CMessageGenerator::GetCompareCppFun() {
   return  "bool " + GetCompareCAndCppFuncName(descriptor_) + "(const " + 
        GetCStructName(descriptor_) + "* " + 
        vars_["param_c_var"] + ", const " + GetCppStructFullName(descriptor_) + 
        "* " + vars_["param_cpp_var"] + ")";
}
