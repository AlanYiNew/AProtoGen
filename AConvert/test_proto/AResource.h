...
struct tagReshelloworld{
    ...
    inline void add_enumValList_(RES_NumVal field) {
      if (enumValListSize >= 1) return
      enumValList_[enumValListSize] = field
      enumValListSize++;
      return;
    }
    inline int enumvallist_size() {
      return enumValListSize;
    }
    inline void enumvallist(int index) {
      return enumValList_[enumValListSize];
    }
    inline RES_NumVal enumval() {
      return enumVal_;
    }
...
struct tagReshelloworldCachedSize_ {
    int32_t str;
    ResInnerCachedSize_ inner1;
    ResInnerCachedSize_ inner2;
    ResInnerCachedSize_ inner3;
    ResInnerCachedSize_ inner4;
    ResInnerCachedSize_ inner5;
    ResInnerCachedSize_ inner6;
    ResInnerCachedSize_ inner7;
    ResInnerCachedSize_ inner8;
    ResobjectCachedSize_ stObject;
    int32_t stringList[10];
    int32_t enumValList;
    int32_t cached_size_;
};
#endif //ARESOURCE_H__