...
void FillReshelloworld(Reshelloworld* msg_obj_c) {
  ...
  {
    if (random()%2) {
      FillResInner(&msg_obj_c->inner1());
    }
  }
  {
    if (random()%2) {
      FillResInner(&msg_obj_c->inner2());
    }
  }
  {
    if (random()%2) {
      FillResInner(&msg_obj_c->inner3());
    }
  }
  {
    if (random()%2) {
      FillResInner(&msg_obj_c->inner4());
    }
  }
  {
    if (random()%2) {
      FillResInner(&msg_obj_c->inner5());
    }
  }
  {
    if (random()%2) {
      FillResInner(&msg_obj_c->inner6());
    }
  }
  {
    if (random()%2) {
      FillResInner(&msg_obj_c->inner7());
    }
  }
  {
    if (random()%2) {
      FillResInner(&msg_obj_c->inner8());
    }
  }
  {
  ...
  }
  {
    ...
    switch (rand_enum) {
      ...
      break;
      case RES_3:{
        FillResInner(&msg_obj_c->stObject.c);
        msg_obj_c->id =RES_3;
      }
      break;
    }
...
bool Comparehelloworld(Reshelloworld* msg_obj_c, Res::helloworld* msg_obj_cpp){
  {
    if (msg_obj_cpp->str().size() !=  strlen(msg_obj_c->str)) {
      std::cout << " helloworld::str size not eq:[c:"
    ...
    if (0 != memcmp(msg_obj_cpp->str().c_str(),&msg_obj_c->str[0], msg_obj_cpp->str().size())) {
  ...
  }
  {
    ...
    if (!CompareInner(&msg_obj_c->inner1(),msg_obj_cpp->mutable_inner1())) return false;
  }
  {
    ...
    if (!CompareInner(&msg_obj_c->inner2(),msg_obj_cpp->mutable_inner2())) return false;
  }
  {
    ...
    if (!CompareInner(&msg_obj_c->inner3(),msg_obj_cpp->mutable_inner3())) return false;
  }
  {
    ...
    if (!CompareInner(&msg_obj_c->inner4(),msg_obj_cpp->mutable_inner4())) return false;
  }
  {
    ...
    if (!CompareInner(&msg_obj_c->inner5(),msg_obj_cpp->mutable_inner5())) return false;
  }
  {
    ...
    if (!CompareInner(&msg_obj_c->inner6(),msg_obj_cpp->mutable_inner6())) return false;
  }
  {
    ...
    if (!CompareInner(&msg_obj_c->inner7(),msg_obj_cpp->mutable_inner7())) return false;
  }
  {
    ...
    if (!CompareInner(&msg_obj_c->inner8(),msg_obj_cpp->mutable_inner8())) return false;
  }
  {
  ...
  switch (msg_obj_c->id) {
    case RES_1:{
      if (fabs(msg_obj_cpp->a() - msg_obj_c->stObject.a) > 0.000001) {
        std::cout << "helloworld::a not equal [c:"
             << msg_obj_c->stObject.a
             << ", cpp:"
             << msg_obj_cpp->a()
             << "]" << std::endl;
        return false;
    ...
    break;
    case RES_2:{
      if (fabs(msg_obj_cpp->b() - msg_obj_c->stObject.b) > 0.000001) {
        std::cout << "helloworld::b not equal [c:"
             << msg_obj_c->stObject.b
             << ", cpp:"
             << msg_obj_cpp->b()
             << "]" << std::endl;
        return false;
    ...
    break;
    case RES_3:{
      if (!CompareInner(&msg_obj_c->stObject.c,
