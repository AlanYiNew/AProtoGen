...
GenerateUnionFieldFunc(int index, const FieldDescriptor* descriptor, Printer& printer) const {
    ...
    vars["one_of_select_varname"] = GetMessageFieldName(GetCStructUnionSelectVarName(descriptor->containing_oneof()));
    ...
    GOOGLE_CHECK(GetOneOfFieldValueName(descriptor->options(), vars["oneof_id"]) == true);
    ...
    printer.Print(vars,
        "if ($has_func$()){\n"
        "    $one_of_select_varname$ = $oneof_id$\n"
        "}\n"
    ...
    printer.Print(vars, "inline int $has_func$() {\n");
    printer.Indent();
    printer.Print(vars, "return $one_of_select_varname$ != $oneof_id$;\n");
    printer.Outdent();
    printer.Print("}\n");
    ...
    printer.Indent();
    //TODO 考虑跟0判断的合理性
    printer.Print(vars, "$one_of_select_varname$ = 0;\n");
    printer.Outdent();
    printer.Print("}\n");
}
...
void CGenerator::GenerateFieldPimitiveFunc(const FieldDescriptor* descriptor, Printer& printer) const{
    ...
    if (descriptor->containing_oneof() != NULL) {
        ...
        // has_xxxx()
        printer.Print(vars, "inline bool $has_func$() {\n");
        printer.Indent();
        printer.Print(vars,
            "return $one_of_select_varname$() == $oneof_id$;\n");
        printer.Outdent();
        printer.Print("}\n");
    ...
    if (IsRepeated(descriptor)) {
        ...
        // add_xxxx
        printer.Print(vars, "inline void add_$name$($primitivetype$ field) {\n");
        printer.Indent();
        printer.Print(vars,
        ...
        // xxxx(i)
        printer.Print(vars, "inline $primitivetype$ $access_func$(int index) {\n");
        printer.Indent();
...
void CGenerator::GenerateFieldEnumFunc(const FieldDescriptor* descriptor, Printer& printer) const {
    ...
    if (IsRepeated(descriptor)) {
        ...
        vars["refer_name"] = GetCArrayLenVarName(descriptor);
        // add_xxxx
        printer.Print(vars, "inline void add_$name$($enumname$ field) {\n");
        printer.Indent();
        printer.Print(vars,
            "if ($refer_name$ >= $max_len_1$) return\n"
            "$name$[$refer_name$] = field\n"
        ...
        // xxxx(i)
        printer.Print(vars, "inline void $access_func$(int index) {\n");
        printer.Indent();
        printer.Print(vars, "return $name$[$refer_name$];\n");
        printer.Outdent();
        printer.Print("}\n");
        ...
        // xxxx
        printer.Print(vars, "inline $enumname$ $access_func$() {\n");
        printer.Indent();
        printer.Print(vars, "return $name$;\n");
        printer.Outdent();
        printer.Print("}\n");
...
void CGenerator::GenerateFieldMessageFunc(const FieldDescriptor* descriptor, Printer& printer) const{
    ...
    if (IsRepeated(descriptor)) {
        ...
        printer.Print(vars, "inline $msgname$* add_$name$() {\n");
        printer.Indent();
        printer.Print(vars,
        ...
        printer.Print(vars, "inline void add_$name$(const $msgname$& field) {\n");
        printer.Indent();
        printer.Print(vars,
            "if ($refer_name$ >= $max_len_1$) return NULL\n"
            "$name$[$refer_name$] = field\n"
...
void CGenerator::GenerateFieldCTypeFunc(const FieldDescriptor* descriptor, Printer& printer) const {
    ...
    if (IsRepeated(descriptor)) {
        ...
        // xxxx(i)
        printer.Print(vars, "inline void $name$(int index) {\n");
        printer.Indent();
        printer.Print(vars, "return $name$[$refer_name$];\n");
        printer.Outdent();
        printer.Print("}\n");
        ...
        // xxxx
        printer.Print(vars, "inline void $access_func$() {\n");
        printer.Indent();
        printer.Print(vars, "return $name$;\n");
        printer.Outdent();
        printer.Print("}\n");
