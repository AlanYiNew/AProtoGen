...
GenerateCompareCAndCpp(Printer* printer) {
    printer->Print(vars_, 
            ...
            "(int)$param_c_var$->$c_name$) {\n"
            "  std::cout << \"$parent_type$::$c_name$ not equal [c:\"\n"
            "       << $param_c_var$->$c_name$ << \", cpp:\"\n"
...
{
    printer->Print(vars_, "$param_cpp_var$.set_$cpp_name$(($cpp_type$)$param_c_var$.$c_name$);\n");
    return true;
}
...
{
    printer->Print(vars_, "$param_c_var$.$c_name$ = ($type$)$param_cpp_var$.$cpp_name$();\n");
    return true;
}
...
GenerateAutoFillC(Printer* printer, bool full_up) {
    GenerateRandom(printer);
    printer->Print(vars_,
      "$param_c_var$->$oneof_var$.$c_name$ = $rand$;\n"
...
GenerateCompareCAndCpp(Printer* printer) {
    printer->Print(vars_, 
            "if ((int)$param_cpp_var$->$cpp_name$() != \n"
            "(int)$param_c_var$->$oneof_var$.$c_name$) {\n"
            "  std::cout << \"$parent_type$::$c_name$ not equal [c:\"\n"
...
bool COneofEnumFieldGenerator::
GenerateAssignCToCpp(Printer* printer) {
    printer->Print(vars_, "$param_cpp_var$.set_$cpp_name$(($cpp_type$)$param_c_var$.$oneof_var$.$c_name$);\n");
    return true;
}
...
GenerateAssignCppToC(Printer* printer)
{
    printer->Print(vars_, "$param_c_var$.$oneof_var$.$c_name$ = ($type$)$param_cpp_var$.$cpp_name$();\n");
    return true;
}
...
GenerateCompareCAndCpp(Printer* printer) {
    ...
    printer->Print(vars_,
      ...
      "  if ((int)$param_cpp_var$->$cpp_name$(i) != (int)$param_c_var$->$c_name$[i]) {\n"
...
GenerateAssignCToCpp(Printer* printer) {
    ...
    printer->Indent();
    printer->Print(vars_, "$param_cpp_var$.add_$cpp_name$(($cpp_type$)$param_c_var$.$c_name$[i]);\n");
    printer->Outdent();
    printer->Print(vars_, "}\n");
    return true;
}
...
GenerateAssignCppToC(Printer* printer) {
    ...
    printer->Indent();
    printer->Print(vars_, "$param_c_var$.$c_name$[i] = ($type$)$param_cpp_var$.$cpp_name$(i);\n");
